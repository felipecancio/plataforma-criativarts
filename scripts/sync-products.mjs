 ...
 *
 * Ordem homepage: Halftone (originais + Vol.2) → demais (Graphic Tee).
 *
...
const products = [
  ...
  // —— Novos (não Halftone) ——
  {
    ...
    is_active: true,
    storage_provider: "r2",
    storage_key: "Animes Lendas Shonen/ANIMES LENDAS SHONEN 120.rar",
  },
  {
    id: "10",
    ...
    is_active: true,
    storage_provider: "r2",
    storage_key: "TEDDY BEAR/TEDDY BEAR 100.rar",
  },
  {
    id: "11",
    ...
    is_active: true,
    storage_provider: "r2",
    storage_key: "JAPANESE SAMURAIS/SAMURAIS 104.rar",
  },
  {
    id: "12",
    ...
    is_active: true,
    storage_provider: "r2",
    storage_key: "ANGELS/ANJOS 85.rar",
  },
  {
    id: "13",
    ...
    is_active: true,
    storage_provider: "r2",
    storage_key: "HIP HOP/HIP HOP 126.rar",
  },
];
